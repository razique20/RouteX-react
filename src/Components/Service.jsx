    ...
    <div className='relative w-full'>
      ...
      <div className='absolute inset-0 flex flex-col justify-center text-blue-900 px-4 md:px-6'>
        ...
        <div className='flex flex-wrap items-center justify-center gap-4 md:gap-6'>
          <div className='bg-white p-4 md:p-6 rounded-lg shadow-lg text-center w-64 md:w-72 lg:w-80 h-64 md:h-72 lg:h-80 flex flex-col justify-center items-center'>
