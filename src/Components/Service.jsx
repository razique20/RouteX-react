...
const Service = () => {
  return (
    <div className='relative w-full py-1'>
      <img src={Bg} alt="Background" className='w-full h-[50vh] md:h-[60vh] lg:h-[68vh] object-cover' />

      <div className='absolute inset-0 flex flex-col justify-center text-blue-900 px-4 md:px-6'>
        <div className='flex flex-col md:flex-row items-center justify-between mx-4 md:mx-6 my-4'>
        ...
        <div className='flex flex-wrap items-center justify-center gap-4 md:gap-1 mt-6'>
          <div className='bg-white p-4 md:p-6 rounded-lg shadow-lg text-center w-full sm:w-80 md:w-72 lg:w-80 flex flex-col justify-center items-center'>
