...
import { IoFastFood, IoRocketOutline } from "react-icons/io5";
  ...
  return (
    <div className="relative w-full py-1">
      <img
        src={Bg}
        alt="Background"
        className="w-full h-[60vh] md:h-[70vh] lg:h-[70vh] object-cover"
      />
      ...
      <div className="absolute inset-0 flex flex-col justify-center text-blue-900 px-4 md:px-6">
        <div className="flex flex-col md:flex-row items-center justify-between mx-4 md:mx-6 my-2">
          <div className="text-left">
            ...
            <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold mt-2 mb-5">
              Discover Your Next
            </h1>
          </div>
        ...
        <div className="flex  items-center justify-center h-60 gap-4 md:gap-1 mt-6">
